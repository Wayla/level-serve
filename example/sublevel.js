...
var ws1 = Store(sub).createWriteStream('white');
fs.createReadStream(__dirname + '/cat.png').pipe(ws1);

sub = db.sublevel('cool').sublevel('cats');
var ws2 = Store(sub).createWriteStream('white');
...
console.log('go to http://localhost:8000/files/cats/white');
console.log('or to http://localhost:8000/files/cool/cats/white');
